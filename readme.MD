...
**[Read the full design paper here →](https://www.linkedin.com/pulse/llm-first-personal-knowledge-management-joel-solymosi-n47qc)**
...
```json
{
  "mcpServers": {
    "memory": {
		 "command": "npx",
         "args": ["-y", "mcp-remote", "http://localhost:8010/mcp/memory"]
    }
  }
}
```
